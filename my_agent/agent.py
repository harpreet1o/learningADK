...
def get_login_troubleshooting_steps(issue_type: str) -> dict:
    ...
    guides = {
        ...
        "account_subscription_expired" : {
            ...
            "steps":[
                "1. Reach directly to customer care to get your subscription renewed and provide the username email and firm name to ensure it is resolved effectively"
            ]
        }
    }
...
root_agent = Agent(
    ...
    tools=[get_login_troubleshooting_steps],
)
